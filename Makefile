...
top_builddir = /Users/carlosejimenez/Downloads/bash-5.1.16
srcdir = .
...
CPPFLAGS = 
CPPFLAGS_FOR_BUILD = 
LOCAL_CFLAGS = -DMACOSX ${DEBUG} ${MALLOC_DEBUG}
DEFS = -DHAVE_CONFIG_H
LOCAL_DEFS = -DSHELL
...
INTL_LIB     = lib/intl/libintl.a -liconv  -Wl,-framework -Wl,CoreFoundation
...
# tests
LIBINTL = lib/intl/libintl.a -liconv  -Wl,-framework -Wl,CoreFoundation
LTLIBINTL = lib/intl/libintl.a -liconv  -Wl,-framework -Wl,CoreFoundation
INTLLIBS = lib/intl/libintl.a -liconv  -Wl,-framework -Wl,CoreFoundation
INTLOBJS = $(GETTOBJS)
